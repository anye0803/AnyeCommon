...
import com.anye.base.model.interf.CustomInterface;
import com.anye.base.util.ScreenUtil;
...
public class CustomViewpager extends RelativeLayout implements CustomInterface {
    ...
    private void onInitView() {
        View view = View.inflate(getContext(), R.layout.anye_viewpager_layout, this);
